...
def _get_curve(params: InputParameters,points_coordinates: Dict[str, Vector], point_name_from: str, point_name_to: str, connection_type: ConnectionType,
    ...
    connection = get_connector_points(params, point1, point_name_from, point2, point_name_to, connection_type)
...
def get_curves(params: InputParameters, points_coordinates: Dict[str, Vector],
    ...
    for point_name_from, point_name_to, connection_type in connected_points:
        curve, connector = _get_curve(params, points_coordinates, point_name_from, point_name_to, connection_type)
        curves.append(curve)
